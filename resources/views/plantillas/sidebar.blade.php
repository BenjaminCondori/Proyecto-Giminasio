<ul class="metismenu" id="side-menu">
    ...
    <li>
        ...
        <ul class="nav-second-level" aria-expanded="false">
            <li>
                <a class="sidebar-link" href="{{ route('dashboard.administrativos') }}">Administrativos</a>
            </li>
            <li>
                <a class="sidebar-link" href="{{ route('dashboard.entrenadores') }}">Entrenadores</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="nav-second-level" aria-expanded="false">
            <li>
                <a class="sidebar-link" href="{{ route('dashboard.disciplinas') }}">Lista de Disciplinas</a>
            </li>
            <li>
                <a href="#">Grupos</a>
            </li>
    ...
    <li>
        ...
        <ul class="nav-second-level" aria-expanded="false">
            <li>
                <a class="sidebar-link" href="{{ route('dashboard.secciones') }}">Lista de Secciones</a>
            </li>
            <li>
                <a href="#">Máquinas o Equipos</a>
            </li>
        </ul>
    </li>
